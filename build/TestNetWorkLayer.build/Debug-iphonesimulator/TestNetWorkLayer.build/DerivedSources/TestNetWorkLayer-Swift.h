...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="TestNetWorkLayer",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC16TestNetWorkLayer11AppDelegate")
...
SWIFT_CLASS("_TtC16TestNetWorkLayer19NativeApiClientSpec")
@interface NativeApiClientSpec : QuickSpec
- (void)spec;
...
SWIFT_CLASS("_TtC16TestNetWorkLayer13SceneDelegate")
...
SWIFT_CLASS("_TtC16TestNetWorkLayer14ViewController")
